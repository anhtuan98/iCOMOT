...
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Fmela%2FMELA-DataService%2F3.0%2FMELA-DataService-3.0.war -O  ./iCOMOT-Platform/webapps/MELA.war
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Fdsg%2Fcloud%2Fsalsa%2Fsalsa-engine%2F2.0%2Fsalsa-engine-2.0.war -O ./iCOMOT-Platform/webapps/salsa-engine.war
              
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Fmela%2FMELA-SpaceAndPathwayAnalysisService%2F3.0%2FMELA-SpaceAndPathwayAnalysisService-3.0.war -O  ./iCOMOT-Platform/webapps1/MELA-AnalysisService.war
...
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Fdsg%2Fcloud%2Fsalsa%2Fsalsa-pioneer%2F2.0%2Fsalsa-pioneer-2.0.jar -O  $CURRENT_DIR/iCOMOT-Platform/salsa-pioneer.jar
...
########## INSTALL rtGovOps ###########
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Finfosys%2Fapimanager%2F1.0%2Fapimanager-1.0.war -O ./iCOMOT-Platform/webapps/APIManager.war
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Finfosys%2Fmanager%2F1.0%2Fmanager-1.0.war -O ./iCOMOT-Platform/webapps/SDGManager.war
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Finfosys%2Fbalancer%2F1.0%2Fbalancer-1.0.war -O ./iCOMOT-Platform/webapps/SDGBalancer.war
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Finfosys%2Fbuilder%2F1.0%2Fbuilder-1.0.war -O ./iCOMOT-Platform/webapps/SDGBuilder.war
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Finfosys%2Fcommon%2F1.0%2Fcommon-1.0.jar -O  ./iCOMOT-Platform/webapps/common-1.0-SNAPSHOT.jar
...
sudo -S wget --no-check-certificate https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2FrSYBL%2Fcontrol-service%2FrSYBL-analysis-engine%2F1.0%2FrSYBL-analysis-engine-1.0-exec-war.jar -O  ./rSYBL/rSYBL-analysis-engine-1.0-SNAPSHOT-war-exec.jar
...
if [ -f ../examples/ElasticIoTCloudPlatform/artifacts/DaaS-1.0.tar.gz ]; then
  ...
  sudo -S wget --no-check-certificate -q https://bintray.com/leduchung/maven/download_file?file_path=at%2Fac%2Ftuwien%2Fdsg%2Ficomot%2FManagingIoTCloudSystems-Tutorial%2F1.0%2FManagingIoTCloudSystems-Tutorial-1.0.tar.gz -P $REPOSITORY/ManagingIoTCloudSystems/
else 	
